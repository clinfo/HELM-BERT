"""HELM-BERT Evidential Regression Lightning Module.
...
class RegressionTrainingConfig:
    """Configuration for evidential regression training.
...
class HELMBertRegressionLightning(L.LightningModule):
    """PyTorch Lightning module for evidential regression.
    ...
    Args:
        ...
        training_config: RegressionTrainingConfig for training settings (required)
    ...
    def _log_model_info(self) -> None:
        ...
        logger.info("Regression Model Configuration (Evidential NIG):")

#!/usr/bin/env python3
"""Convert Propedia peptide sequences to HELM notation using RDKit."""
...
log_dir = Path("outputs") / "preprocessing" / f"propedia_helm_conversion_{timestamp}"
...
def main():
    """Main function."""
    # Define file paths
    input_file = "local_data/intermediate/propedia.csv"
    output_file = "local_data/intermediate/propedia_helm.csv"

    logger.info("Starting Propedia peptide-to-HELM and SMILES conversion...")

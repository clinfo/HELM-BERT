...
DEFAULT_SOURCE = REPO_ROOT / "local_data/intermediate/propedia_helm.csv"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "local_data/downstream"
...
def main():
    ...
    # Save
    train_file = output_dir / "propedia_ppi_train.csv"
    test_file = output_dir / "propedia_ppi_test.csv"
